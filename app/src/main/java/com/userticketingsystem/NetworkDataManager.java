...
public class NetworkDataManager<T extends ApiResponse> {
    ...
    public static final String INTERNAL_SERVER_ERROR_MESSAGE = "Something went wrong. Contact DTC";
        ...
        call.enqueue(new Callback<T>() {
            ...
            public void onResponse(Call<T> call, Response<T> response) {
                if (response.isSuccessful()) {
                    ...
                    listener.onFailure(INTERNAL_SERVER_ERROR_CODE, response.message());
                }
            }
